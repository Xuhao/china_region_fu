...
3. After you install wulin_master gem, you need run the generator:
   ...
   It will generator <b><em>db/migrate/<timestamp>_create_grid_states.rb</em></b> migrate file to your app,
   _grid_states_ table is used for store the grid states for each user.

   Run with <b><em>bundle exec rails g</em></b> for get generator list.
...
4. Assume generator a new grid called *grid_test*, run the generator:
   ...
   <b><em>name:string age:integer</em></b> are the columns of the grid, same as the <b><em>[field:type field:type]</em></b> 
